...
int main(int, char **) {
    constexpr int N=2;
    simplexNelderMeadMethodMinimization::simplex<double,N>::vertex startingvertex;
    for(int i=0;i<N;++i) {
        startingvertex[i]=1.0;
    }
    auto t = simplexNelderMeadMethodMinimization::minimizerNelderMeadFromStartingVertex<double,N>(2.5,startingvertex,[](double* x)->double{
